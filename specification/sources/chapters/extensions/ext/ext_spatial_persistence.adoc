...
* See <<fundamentals-buffer-size-parameters>> chapter for a detailed
  description of retrieving the required pname:persistenceScopes size.
****
...
[[ext_spatial_persistence_discover_all_entities]]
...
XrSpatialPersistenceContextEXT persistenceContext {XR_NULL_HANDLE};

XrSpatialPersistenceContextCreateInfoEXT persistenceContextCreateInfo{
...
XrSpatialContextEXT spatialContext{};
{
  ...
  XrSpatialContextPersistenceConfigEXT persistenceConfig{
    .type = XR_TYPE_SPATIAL_CONTEXT_PERSISTENCE_CONFIG_EXT,
    .persistenceContextCount = 1,
...
auto discoverSpatialEntities = [&](XrSpatialContextEXT spatialContext, XrTime time) {
  ...
  if (completion.futureResult == XR_SUCCESS) {
    ...
    XrSpatialComponentPersistenceListEXT persistenceDataList {
      .type = XR_TYPE_SPATIAL_COMPONENT_PERSISTENCE_LIST_EXT,
      .persistDataCount = static_cast<uint32_t>(persistenceData.size()),
      .persistData = persistenceData.data(),
    };
...
auto discoverSpatialEntities = [&](XrSpatialContextEXT spatialContext, XrTime time) {
  XrSpatialDiscoveryPersistenceUuidFilterEXT persistenceFilter {
    .type = XR_TYPE_SPATIAL_DISCOVERY_PERSISTENCE_UUID_FILTER_EXT,
    .persistedUuidCount = static_cast<uint32_t>(uuidsStoredByApp.size()),
    .persistedUuids = uuidsStoredByApp.data(),
  };

  XrSpatialDiscoverySnapshotCreateInfoEXT snapshotCreateInfo {
    .type = XR_TYPE_SPATIAL_DISCOVERY_SNAPSHOT_CREATE_INFO_EXT,
    .next = &persistenceFilter,
    .componentTypeCount = static_cast<uint32_t>(snapshotComponents.size()),
    .componentTypes = snapshotComponents.data(),
  };

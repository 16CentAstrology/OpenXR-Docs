...
[[ext_spatial_plane_tracking_polygon_2d_component]]
...
XrSpatialCapabilityConfigurationPlaneTrackingEXT planeConfig{
...
auto discoverSpatialEntities = [&](XrSpatialContextEXT spatialContext, XrTime time) {
  ...
  if (completion.futureResult == XR_SUCCESS) {
    ...
    XrSpatialComponentPolygon2DListEXT polygonList {
    ...
    XrSpatialComponentPlaneSemanticLabelListEXT semanticLabelsList {
